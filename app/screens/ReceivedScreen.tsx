...
interface ReceivedScreenProps extends AppStackScreenProps<"Received"> {}

export const ReceivedScreen: FC<ReceivedScreenProps> = observer(function ReceivedScreen() {
  ...
  const { firestore, updateTransaction } = useFirestore()
  ...
  return (
    ...
    >
      <Text testID="login-heading" tx="receivedScreen.title" preset="heading" style={$signIn} />
      ...
      <TextField
        ...
        labelTx="receivedScreen.yourName"
        placeholderTx="receivedScreen.yourNamePlaceholder"
      ...
      <TextField
        ...
        autoCorrect={false}
        keyboardType="default"
        labelTx="receivedScreen.clientName"
        placeholderTx="receivedScreen.clientNamePlaceholder"
      ...
      <TextField
        ...
        labelTx="receivedScreen.amount"
        placeholderTx="receivedScreen.amountPlaceholder"
      ...
      <TextField
        ...
        autoCorrect={false}
        keyboardType="default"
        labelTx="receivedScreen.description"
        placeholderTx="receivedScreen.descriptionPlaceholder"
        multiline
      />
      ...
      <TextField
        ...
        autoCorrect={false}
        keyboardType="default"
        labelTx="receivedScreen.category"
        placeholderTx="receivedScreen.categoryPlaceholder"
      />

      <Button
        testID="login-button"
        tx="receivedScreen.submit"
        style={$tapButton}
        preset="reversed"
        onPress={() => {
          login(myName)
